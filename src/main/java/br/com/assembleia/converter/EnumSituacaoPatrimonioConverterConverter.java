 ...
 * @author ferna
 */
@FacesConverter("enumSituacaoPatrimonioConverter")
public class EnumSituacaoPatrimonioConverterConverter implements Converter {

    @Override
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        if (value != null) {
            return EnumSituacaoPatrimonio.getSituacao(value);
        }
        return null;
    }
